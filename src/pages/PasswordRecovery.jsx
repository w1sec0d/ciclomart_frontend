...
const PasswordRecovery = () => {
    ...
    const onSubmit = async (data) => {
        try {
           ...
           if(data.password === data['password-confirm']){
            ...
            const request = await loginService.recoveryPassword(data.password,token);
    ...
    return (
        ...
        <div className="flex items-center justify-center min-h-screen by-gray-100">
            ...
            <h1 className="font-black text-5xl text-center" > Recuperación de contraseña </h1>
            <p className="text-center mt-3">Por favor ingresa tu nueva contraseña</p>
